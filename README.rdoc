...
Using the Google Translate service as the speech engine, this gem generates a .mp3 file from any given string.

== Install
     [sudo] gem install tts

== Usage
     # Will downloard "Hello World!.mp3" to your current directory
     ...
     # If you have problems reaching the Google Translate server, you can set another server url
